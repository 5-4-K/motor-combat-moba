...
- **2026-09-16, bigger cars (not part of this rework):** the hull grew 48×32 → 60×40 and
  `RAM_CONFIG.spinScale` moved 10 → 12.5 to hold every ram's spin constant (1.25x lever / 1.5625x
  inertia). Stage 5's re-pitch starts from 12.5. `globalScale` did not move — push never read the hull.
