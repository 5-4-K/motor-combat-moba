...
Extremely simplified flat vector game sprite, legible at 72x48 pixels. Bold
...
| **No empty margin** | The importer fits art to the 72×48 hull. Heavy transparent padding makes the car render small inside its own hitbox, and the fix is a hand-tuned `scale`. |
| **Legible at 72x48** | That is the hull, and the whole car is drawn at roughly that size. Detail below it is invisible at best and noise at worst. |
