...
[reconciliation tracker](docs/superpowers/plans/2026-08-28-invariant-reconciliation-tracker.md).
...
| **Netcode / browser invariants, the audit against them, and the rulings (R0–R8)** — start at the tracker | [`docs/superpowers/plans/2026-08-28-invariant-reconciliation-tracker.md`](docs/superpowers/plans/2026-08-28-invariant-reconciliation-tracker.md) |
