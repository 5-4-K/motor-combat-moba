...
export class ArenaScene extends Phaser.Scene {
  ...
  private applyEnvironment(): void {
    ...
    // The floor ART's knock-back (never the generated asphalt, which `floor.*` owns and this arena
    // does not draw when a sprite resolved). Here rather than in `drawArena` so the playground's
