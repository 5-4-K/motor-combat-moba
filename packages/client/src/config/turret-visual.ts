 ...
 * NOT the sim's spawn offset: `turret().defaultOffset` is tuned to put the shot on this length's
 ...
 * block centred on the pivot plus a barrel running `turret().defaultOffset` along +x, so the
