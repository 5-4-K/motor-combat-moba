...
- **The rim is a copy of the car's own ART**, tinted and nudged toward the light behind the body —
  not a stroked outline. The hull is a 72x48 box the sprites do not fill, so stroking it drew a
