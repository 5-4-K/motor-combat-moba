 ...
 * ticks, the ram durations (`ramTicks()`), and each exploding weapon's synthesized burst def
 * (`BURST_DEFS`) — have to be told to re-resolve. Anything else derived from one of these tables at
